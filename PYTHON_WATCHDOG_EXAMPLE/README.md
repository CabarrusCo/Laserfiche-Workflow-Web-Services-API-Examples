...
## Things to consider
+ This example assumes that you have to authenticate to IIS. It uses requests_nltm for this setup(test server to test server). If your server is setup for anonymous authetication, you may not NEED the requests_ntlm auth part or may have to tweak it if you're using Kerberos.
